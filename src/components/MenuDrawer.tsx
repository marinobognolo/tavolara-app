        ...
        <nav className="px-8 pt-10">
          {MAIN_ITEMS.slice(0, 2).map((item) => (
            <Link key={item.label} href={item.href} onClick={close}
              className="block py-2 font-body font-extrabold text-6xl uppercase text-white leading-none">
              {item.label}
            </Link>
          ))}
          ...
          >
            <span className="font-body font-extrabold text-6xl uppercase text-white leading-none">SQUADRE</span>
      ...
      >
        <div className="px-8 pt-10">
          ...
          <button onClick={() => setLevel("main")} className="flex items-center gap-2 mb-8">
            ...
            <span className="font-body font-extrabold text-6xl uppercase text-oro leading-none">SQUADRE</span>
          </button>
          ...
          <nav>
            {SQUADRE_ITEMS.map((item) => {
              ...
              return (
                <Link key={item.label} href={item.href} onClick={close}
                  className={`block py-2 font-body font-extrabold text-6xl uppercase leading-none transition-colors ${
